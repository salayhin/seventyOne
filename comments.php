...
<?php else : ?>
              ...
              <div id="form-section-author" class="form-section">
								<div class="form-input"><?php _e('Name', 'your-theme') ?> <?php if ($req) _e('<span class="required">*</span>', 'your-theme') ?>&nbsp;:&nbsp;<input id="author" name="author" type="text" value="<?php echo $comment_author ?>" size="30" maxlength="20" tabindex="3" /></div>
              </div><!-- #form-section-author .form-section -->

              <div id="form-section-email" class="form-section">

								<div class="form-input"><?php _e('Email', 'your-theme') ?> <?php if ($req) _e('<span class="required">*</span>', 'your-theme') ?>&nbsp;:&nbsp;<input id="email" name="email" type="text" value="<?php echo $comment_author_email ?>" size="30" maxlength="50" tabindex="4" /></div>
              </div><!-- #form-section-email .form-section -->

              <div id="form-section-url" class="form-section">

								<div class="form-input"><?php _e('Website', 'your-theme') ?>:&nbsp;<input id="url" name="url" type="text" value="<?php echo $comment_author_url ?>" size="30" maxlength="50" tabindex="5" /></div>
...
<?php endif /* if ( $user_ID ) */ ?>
              ...
              <div id="form-section-comment" class="form-section">
								...
								<div class="form-textarea"><textarea id="comment" name="comment" cols="80" rows="8" tabindex="6" class="span6"></textarea></div>
